      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          @if(Cart::instance('cart')->content()->where('id',$product->id)->count()>0)
            <a href="{{route('cart.index')}}" class="btn btn-warning mb-3">Go t cart</a>
            @else 
          <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
            ...
            <div class="product-single__addtocart">
              ...
              <input type="hidden" name="price" value="{{$product->price == '' ? $product->regular_price : $product->sale_price}}">
