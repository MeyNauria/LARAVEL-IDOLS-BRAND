        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="assets/images/home/demo3/myunggjae.png" width="642" height="833"
                alt="Woman Fashion 1"
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                Newest Doll</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Boynextdoor Sweet</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">MERCHANDISE</h2>
              <a href="#"
        ...
        <div class="swiper-slide">
          <div class="slideshow-character position-absolute bottom-0 pos_right-center">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                New Arrivals</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Look For Match?</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">WITH IDOLS!</h2>
              <a href="#"
                class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
                Now</a>
            </div>                             
